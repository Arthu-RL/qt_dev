...
def run(project_path: str, image: str, container_name: str = 'vulkan-dev') -> None:
    run_command: str = f"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--image_tag', dest='image_tag', type=str, help='Tag of the dev image', default='arthur')
    ...
    if args.run:
        run(project_path=args.project_path, image=image)
    else:
        build(image=image)
