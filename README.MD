...
```bash
python build_run.py --build --base --retry 2 --image_tag="base"
python build_run.py --build --retry 2 --image_tag="1.0"
```
...
```bash
python build_run.py --run --project_path="/absolute/path/to/your/workspace" --image_tag="1.0"
```
